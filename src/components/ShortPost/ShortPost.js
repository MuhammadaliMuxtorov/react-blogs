  ...
  return (
    <Link to={`/Post/${props.id}`}>
      <h5 className="list-group-item row">
        <span className="d-inline-block col-sm-4 text-danger">
          {props.title}
        </span>
        <span className="d-inline-block col-sm-4 text-right text-warning">
          {date.toLocaleDateString()}
        </span>
        <span className="d-inline-block col-sm-4 text-info text-right ">
